...
.. image:: https://readthedocs.org/projects/shm6886-prompt-risk/badge/?version=latest
...
.. .. image:: https://img.shields.io/badge/Link-API-blue.svg
    :target: https://shm6886-prompt-risk.readthedocs.io/en/latest/py-modindex.html
...
==============================================================================
.. .. image:: https://shm6886-prompt-risk.readthedocs.io/en/latest/_static/prompt_risk-logo.png
    :target: https://shm6886-prompt-risk.readthedocs.io/en/latest/
...
- `Full Documentation <https://shm6886-prompt-risk.readthedocs.io/en/latest/>`_ — Project background, risk taxonomy, governance recommendations, and API reference.
- `Prompt Evaluation Demo <https://shm6886-prompt-risk.readthedocs.io/en/latest/06-Prompt-Runner-And-Evaluation-Demo/index.html>`_ — Interactive notebook: run prompts against test cases and evaluate outputs.
- `Judge Assessment Demo <https://shm6886-prompt-risk.readthedocs.io/en/latest/08-Judge-Demo/index.html>`_ — Interactive notebook: run LLM-as-Judge on prompt versions and inspect risk scores.
